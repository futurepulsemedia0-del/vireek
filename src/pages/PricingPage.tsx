        ...
        <section className="px-6 py-16 sm:py-20">
          <div className="mx-auto max-w-6xl">
            ...
            <motion.div
              ...
              className="mt-12 overflow-x-auto rounded-3xl border border-border bg-bg-secondary shadow-card dark:shadow-card-dark"
            >
              <table className="w-full min-w-[720px] border-collapse text-left">
                ...
                <tbody>
                  {COMPARE_ROWS.map((row, rowIndex) => (
                    ...
                    >
                      <td
                        className={`sticky left-0 z-10 px-6 py-4 text-sm font-medium text-text-primary ${
