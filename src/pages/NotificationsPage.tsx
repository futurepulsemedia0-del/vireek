...
export function NotificationsPage() {
  ...
  // Live updates — mirrors the header bell's subscription so this page never
  // shows stale data while it's open. Handles new notifications arriving,
  // read-state changes made elsewhere (e.g. the bell), and deletions.
  useRealtimeSubscription<NotificationRow>({
    channelName: `notifications-page-${accountOwnerId ?? 'anon'}`,
    table: 'notifications',
    event: '*',
