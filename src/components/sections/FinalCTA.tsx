...
export function FinalCTA() {
  ...
  const GUARANTEES = [
  { icon: Clock, label: t('finalCta.guaranteeLive') },
  { icon: ShieldCheck, label: t('finalCta.guaranteeNoCard') },
  { icon: Zap, label: t('finalCta.guaranteeCancel') },
];
  return (
      ...
      <div className="mx-auto max-w-5xl px-5 sm:px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-text-secondary sm:text-lg">
            {t('finalCta.subhead')} reached a real voice instead of a beep.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div>
              <p className="text-sm font-medium text-white/75">{t('finalCta.getStarted')}</p>
              <p className="mt-1 text-xl font-semibold text-white">{t('finalCta.startTrial')}</p>
              <p className="mt-1.5 text-sm text-white/75">{t('finalCta.trialTerms')}</p>
            </div>
          ...
          >
            <div>
              <p className="text-sm font-medium text-text-secondary">{t('finalCta.hearFirst')}</p>
              <p className="mt-1 text-xl font-semibold text-text-primary">{t('finalCta.callNow')}</p>
              <p className="mt-1.5 text-sm text-text-secondary">{t('finalCta.callSubtitle')}</p>
            </div>
