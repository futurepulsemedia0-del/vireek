      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6">
        ...
        <div className="mt-10 grid gap-4 sm:mt-14 sm:gap-6 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="flex h-[440px] flex-col overflow-hidden rounded-2xl border border-border bg-bg-tertiary sm:h-[520px]"
          >
            <div className="flex items-center gap-2 border-b border-border bg-bg-secondary px-4 py-3.5 sm:px-5 sm:py-4">
              <Sparkles size={15} className="text-accent sm:size-4" />
              ...
              {messages.map((msg, i) => {
                ...
                return (
                  <div key={i} className={`flex items-end gap-3 ${isSarah ? 'flex-row' : 'flex-row-reverse'}`}>
                    ...
                    <div
                      className={`max-w-[80%] rounded-2xl px-3.5 py-2.5 text-sm leading-relaxed sm:px-4 sm:py-3 ${
                        isSarah
            ...
            >
              ...
              <button
                ...
                className="focus-ring flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-accent text-white transition-opacity hover:brightness-110 active:scale-95 disabled:opacity-40"
              >
                <Send size={16} />
              </button>
            </form>
