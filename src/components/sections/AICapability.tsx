...
export function AICapability() {
  return (
    <section id="ai-capability" className="relative overflow-hidden py-24 md:py-32">
      {/* Ambient backdrop */}
      <div
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className={sectionHeadingClass()}>Not a Chatbot. A Voice Receptionist.</h2>
          <p className={bodyClass()}>
            Generic AI assistants read scripts and follow rigid decision trees. Sarah listens,
            understands, and thinks on her feet — the way your best receptionist would.
          </p>
        </motion.div>
        ...
        >
          {CAPABILITIES.map(({ icon: Icon, title, body }) => (
            <motion.div
              ...
              variants={fadeUpItem}
              transition={{ duration: 0.5, ease: EASE }}
              className="group relative overflow-hidden rounded-2xl border border-border bg-bg-secondary p-7 shadow-card transition-all duration-300 ease-out hover:-translate-y-1 hover:border-accent/30 hover:shadow-card-hover dark:shadow-card-dark dark:hover:shadow-card-hover-dark"
            >
              {/* Subtle hover glow */}
              <div
